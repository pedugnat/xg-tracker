...
MEANING_LEAGUE_XPTS_GRAPH = """**Les xPoints de chaque équipe sont indiqués en abscisse (axe horizontal). 
                        Les points effectivement pris sont indiqués en 
                        ordonnée (axe vertical). Chaque point représente une équipe 
                        et la couleur représente l'écart entre les 
                        xPoints et les vrais points marqués.**"""

MEANING_LEAGUE_XGA_GRAPH = """**Les xGoal Against de chaque équipe sont indiqués en abscisse (axe horizontal). 
                        Les buts effectivement concédés sont indiqués en 
                        ordonnée (axe vertical). Chaque point représente une équipe 
                        et la couleur représente l'écart entre les 
                        xGA et les buts effectivement concédés.**"""

MEANING_XG_GRAPH = """**Les xGoals de chaque joueur sont indiqués en abscisse (axe horizontal). 
                            Les buts effectivement marqués sont indiqués en 
...
MEANING_XA_GRAPH = """**Les xAssists de chaque joueur sont indiqués en abscisse (axe horizontal). 
...
MEANING_DIFF_SITUATIONS = """**Ce graph représente la différence entre le nombre de 
...
MEANING_DIFF_SHOTS = """**Ce graph représente la différence de qualité de tirs 
